 ...
 * USB service and springboards to the main launcher activity
 */
public final class UsbAccessoryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent intent = new Intent(this,org.ros.rosserial.RosserialLauncherActivity.class);
		...
		try {
			...
			Log.e(TAG, "unable to start Rosserial Launcher activity", e);
		}
		finish();
	}
}
